...
namespace _01.RetrieveNumberOfCategariesNorthwind {
    ...
    internal sealed partial class SQLSettings : global::System.Configuration.ApplicationSettingsBase {
        ...
        [global::System.Configuration.UserScopedSettingAttribute()]
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.Configuration.DefaultSettingValueAttribute("SELECT COUNT(*) FROM [northwind].[dbo].[Categories]")]
        public string sqlGetCategoriesCount {
            get {
                return ((string)(this["sqlGetCategoriesCount"]));
            }
            set {
                this["sqlGetCategoriesCount"] = value;
            }
        }
    }
}
